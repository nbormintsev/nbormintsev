...
- Async trading bots serving 15+ strategies across 6 exchanges
- Multi-tenant RAG service on a private LLM
- AI-powered content validation for music distribution
- Granular permission system with label-scoped roles and dynamic action resolution
